//Tarea 4: Programa 2.
/*Programa que pide al usuario cinco números enteros positivos (entre 1 y 30) por cada número leído, el programa imprime una línea que contiene dicho número de asteriscos adyacentes.
  El programa debe preguntar al usuario si desea introducir otros 5 números, para repetir el ejercicio. */
